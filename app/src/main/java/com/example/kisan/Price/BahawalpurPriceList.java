...
public class BahawalpurPriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bahawalpur_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("Bahawalpur");
        mRef4date = mDatabase.getReference("BwlDate");
