...
public class GujranwalaPriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gujranwala_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("Gujranwala");
        mRef4date = mDatabase.getReference("GjwDate");
