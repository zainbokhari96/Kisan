...
public class KhanewalPriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khanewal_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("Khanewal");
        mRef4date = mDatabase.getReference("KnlDate");
