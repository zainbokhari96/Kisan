...
public class LahorePriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lahore_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("Lahore");
        mRef4date = mDatabase.getReference("LhrDate");
