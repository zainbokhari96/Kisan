...
public class RahimYarKhanPriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rahim_yar_khan_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("RahimYarKhan");
        mRef4date = mDatabase.getReference("RykDate");
