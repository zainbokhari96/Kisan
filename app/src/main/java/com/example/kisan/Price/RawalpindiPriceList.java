...
public class RawalpindiPriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rawalpindi_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("Rawalpindi");
        mRef4date = mDatabase.getReference("RwpDate");
