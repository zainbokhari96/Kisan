...
public class ShiekhupuraPriceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shiekhupura_price_list);

        mDatabase = FirebaseDatabase.getInstance();
        mRef = mDatabase.getReference("Shiekhupura");
        mRef4date = mDatabase.getReference("ShpDate");
